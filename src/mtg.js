...
function Mtg() {
  return (
    <div id="mtg">
      ...
      <h2>{'Cubes'}</h2>
      <ul>
        <li><a href="https://cubecobra.com/cube/list/61c0cf61ee4126240637305e?view=table&scale=medium">{'Battle Box'}</a></li>
        <li><a href="https://cubecobra.com/cube/overview/2txn5">{'Pauper Cube'}</a></li>
      </ul>
    </div>
  );
}
