...
function Privacy() {
  return (
    <>
      ...
      <p>
        This privacy policy applies to the Friends Builder app (hereby referred
        to as “Application”) for mobile devices that was created by Katerberg
        LLC (hereby referred to as “Service Provider”) as a Commercial service.
      ...
      <p>
        ...
        Service Provider (soft.gift1392@fastmail.com) so that they will be able
      ...
      <br />
      <p>This privacy policy is effective as of 2024-06-20</p>
      <br />
      ...
      <p>
        ...
        Provider via email at soft.gift1392@fastmail.com.
      </p>
      <hr />
      <p>
